...
| 10 — Gate runtime, queues, journal, receipts | Partial | The 13-stage actor, fallible configuration, boot/store-bound startup, signed receipts, in-memory single-slot publication typestate, canonical linked publication-stage payload/reducer primitives, and a bounded locked evidence directory manager with opt-in ordered opaque recovery snapshots exist (`CL-CONFIG-01`, `CL-PUBLICATION-STATE-01`, `CL-PUBLICATION-EVIDENCE-PRIMITIVE-01`, `CL-DURABLE-STARTUP-DEV-01`, `CL-EVIDENCE-MANAGER-01`); service/package loading, bounded async queues, COSE/journal verifier, capacity reservation, actor journal selection, manager-to-reducer replay, and crash-tested recovery do not (`CL-DURABLE-01`). |
