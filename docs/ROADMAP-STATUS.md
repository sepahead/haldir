...
| 10 — Gate runtime, queues, journal, receipts | Partial | The 13-stage actor, fallible configuration, boot/store-bound startup, signed receipts, in-memory single-slot publication typestate, and a bounded locked evidence directory manager exist (`CL-CONFIG-01`, `CL-PUBLICATION-STATE-01`, `CL-DURABLE-STARTUP-DEV-01`, `CL-EVIDENCE-MANAGER-01`); service/package loading, bounded async queues, actor journal selection, durable publication-stage reduction, and crash-tested recovery do not (`CL-DURABLE-01`). |
