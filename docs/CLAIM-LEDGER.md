...
| CL-DECISION-ID-01 | Decision ids come from a checked counter with a boot-unique prefix; exhaustion latches a fault and errors instead of wrapping (H-H06). | PROVEN | `haldir-gate` `decision_id_exhaustion_latches_error` |
